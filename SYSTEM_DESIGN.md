...
10\. Flutter Android & iOS App Design ................................................................................ 21
...
The platform consists of a Flutter Android & iOS app (runs from Xcode onto iPhone), a Next.js web admin dashboard, and a real-time Node.js backend.
...
│ │ Flutter Android & iOS App │ │ Web Admin Dashboard │ │ Live Display │ │
...
| ------------- | ----------------------- | --------------------------------------------------------------------------------- |
| Mobile Client | Flutter (Dart)          | Cross‑platform, single codebase for Android & iOS, Stripe SDK via flutter_stripe, Apple Pay & Google Pay support |
...
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mobile App    | Bidder registration, Apple/Google Pay linking via flutter_stripe, bid placement, group creation/joining via code or QR, contribution editing, anonymous display name selection, push notifications, offline bid queuing (sqflite/hive) |
...
# 10. Flutter Android & iOS App Design

## 10.1 App Architecture

MVVM pattern with Provider/Riverpod for state management, a service layer for networking and WebSocket, and Stripe Flutter SDK for Apple Pay/Google Pay integration.
...
| Mobile framework | Flutter (Dart)            | React Native            | Native Apple Pay via PassKit on iOS, Google Pay on Android, single codebase, cross‑platform deployment via Android Studio & Xcode. |
...
| --------------- | ---------------------------------------- | ------------------------ |
| Mobile App      | Flutter + Dart + flutter_stripe SDK      | 2.0+ / Android 6+, iOS 12+ |
...
Bidder registration with display names and anonymity modes. Item CRUD and individual bidding. Basic Flutter app (Android and iOS): join event, item gallery, bid placement. Web dashboard: item management, live bid feed. WebSocket real-time updates. Stripe customer creation and Apple Pay linking.
